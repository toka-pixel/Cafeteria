...
//               // array_shift($_SESSION['shopping_cart']);
            

//               // $iOne = array_combine(range(1, count(  $_SESSION['shopping_cart'])), array_values(  $_SESSION['shopping_cart']));
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="homeUser.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<div class="container">
 ...
 <div class="row">
   ...
   <form  action="user-insert-orders.php"  method="GET"  id="order-form" >
